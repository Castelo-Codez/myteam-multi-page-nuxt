...
<template>
    <section
        class="pt-16 pb-40 lg:pb-52 bg-color-midnight-green relative overflow-hidden"
    >
        <div
            class=" container lg:px-11 flex flex-col gap-y-10 lg:flex-row lg:items-end lg:gap-x-52"
        >
            <h1
                class=" relative text-color-white lg:flex-[0_0_40%]  max-w-[80%]  font-[700] mx-auto lg:mx-0 text-[3rem] text-center lg:leading-[5rem] lg:max-w-none lg:text-left lg:text-[calc(1.0rem_+_4vw)]  "
            >
                <div>
                    Find the best
                    <span class=" inline  text-color-light-coral">
                        talent
                    </span>
                </div>
                <div
                    aria-hidden="true"
                    class="  hidden xl:block absolute  -left-[60%] -top-4"
                >
                    <svg
        ...
        <div
            aria-hidden="true"
            class=" absolute  bottom-0 left-2/4 -translate-x-2/4 lg:-translate-x-[-20%] xl:-translate-x-[-80%]"
        >
