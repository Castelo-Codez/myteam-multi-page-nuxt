<template>
    <section
        class=" py-32  relative overflow-hidden  bg-color-very-dark-green"
    >
        <div class="container lg:grid lg:grid-cols-2 lg:items-start">
            <MainArticle
            ...
            />
            <div
                class=" absolute top-0 -right-[calc(18%_+_8vw)] sm:-right-[8%] 2xl:-right-[calc(6%_+_1vw)] 2xl:top-[60%]"
                aria-hidden="true"
            >
                <svg
            ...
            <ul class=" mt-14 flex flex-col  gap-y-8">
                <li
                    class=" flex flex-col items-center text-center md:items-start md:text-left lg:flex-row  lg:gap-x-8 lg:items-center"
                >
                    <div>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <article class="mt-5 flex flex-col gap-y-2">
                        <h2
                            class=" font-[700] text-color-light-coral text-[1.1rem]"
                        >
                            Experienced Individuals
                        </h2>
                        <p class=" text-white font-[600] md:max-w-[90%]">
