...
const [firstName, lastName] = props.author.split(" ");
</script>
<template>
    <li class="relative flex z-10 flex-col gap-y-3 items-center">
        <q class="text-center text-color-white font-[500]">{{ props.quote }}</q>
        <article class="text-center">
            <h4 class="text-color-rapture-blue text-[1.3rem] font-[700]">
                {{ props.author }}
            </h4>
        ...
        <div
            aria-hidden="true"
            class="absolute z-[-1] -top-5 left-2/4 -translate-x-2/4"
        >
