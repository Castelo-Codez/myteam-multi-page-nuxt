<template>
    <section
        class="py-20 bg-color-light-coral relative z-10  overflow-hidden"
    >
        <div
            class="container grid justify-center gap-y-4 md:grid-cols-[auto_auto] md:justify-between md:items-center"
        >
            <h1
                class=" text-[calc(1.2rem_+_4vw)] tracking-[-1px] sm:text-[calc(0.2rem_+_3vw)] text-center font-[700] text-color-dark-green"
            >
                Ready to get started?
            </h1>
            <Button :is-light="false" />
            <div
                aria-hidden="true"
                class=" absolute -bottom-5 2xl:bottom-0  z-[-1]  left-0"
            >
                <svg
