<template>
    <section class="py-40 relative bg-color-sacramento-state-green">
        <div class="container">
            <h2
                class="text-center text-color-white lg:max-w-[68%] leading-[3rem] mx-auto text-[2rem] lg:text-[2.8rem] font-[700]"
            >
                Delivering real results for top companies. Some of our
                <span class="text-color-rapture-blue ml-3">
                    success stories.
                </span>
            </h2>
            <div aria-hidden="true" class="absolute top-0 left-0">
                <svg
